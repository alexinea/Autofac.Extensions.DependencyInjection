...
This project forked from [Autofac Official](https://github.com/autofac/Autofac.Extensions.DependencyInjection). This package allows you to used in .NetStandard1.6, .NetStandard 2.0 and .NET Framework 4.6.1.
